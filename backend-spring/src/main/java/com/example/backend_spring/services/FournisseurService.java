...
public class FournisseurService {
    ...
    public Fournisseur saveFournisseur(Fournisseur fournisseur, Utilisateur utilisateur) {
        ...
        String details = isNew ? "Création du fournisseur " + saved.getNom() : "Modification du fournisseur " + saved.getNom();
    ...
    public Fournisseur toggleStatus(int id, Utilisateur utilisateur) {
        ...
        journalAuditService.logAction(utilisateur, action, "FOURNISSEUR", String.valueOf(saved.getId()), action + " du fournisseur " + saved.getNom());
        
        return saved;
    }

    public List<BonCommandeFournisseur> getFournisseurOrders(int id) {
        return bonCommandeRepository.findByFournisseurIdOrderByDateCommandeDesc(id);
    }
    ...
    public Map<String, Object> getFournisseurStats(int id) {
        List<BonCommandeFournisseur> orders = bonCommandeRepository.findByFournisseurIdOrderByDateCommandeDesc(id);
        ...
        // Indicateur à risque : aucune commande depuis 6 mois si déjà client, ou statut inactif
