...
- Consommation Budgétaire par Département (Gauge Chart) : Un graphique en forme de jauge pour chaque département (Finance, Logistique, etc.) montrant le pourcentage du budget consommé par rapport au total alloué.
- Alerte de Dépassement Budgétaire (Notification) : Liste des départements ayant dépassé 90% de leur budget.